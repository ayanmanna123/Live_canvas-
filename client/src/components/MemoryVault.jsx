    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          animate={{ scale: 1, y: 0 }}
          exit={{ scale: 0.9, y: 20 }}
          className="bg-white/90 backdrop-blur-3xl rounded-[2.5rem] w-full max-w-4xl max-h-[80vh] overflow-hidden border border-white/60 shadow-[0_20px_60px_-15px_rgba(244,63,94,0.3)] flex flex-col"
          ...
          <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
            {loading ? (
              ...
              <div className="h-64 flex flex-col items-center justify-center text-center gap-4">
                ...
                <div>
                  <p className="text-rose-900 font-black uppercase tracking-widest">No memories yet</p>
                  <p className="text-rose-400 text-sm font-medium">Capture your first moment from the toolbar!</p>
                </div>
              </div>
            ) : (
